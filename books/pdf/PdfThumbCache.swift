...
//class PdfThumbCache:NSObject// <NSObject>
//{
//    var thumbCache:NSCache?;
//
////#pragma mark Constants
//
//    let CACHE_SIZE:Int = 2097152;
    //class var predicate:dispatch_once_t?;// = 0;

//#pragma mark ReaderThumbCache class methods
    
//    class func sharedInstance()->ReaderThumbCache?
//{
////    class var predicate:dispatch_once_t  = 0;
////    
////    static var object:ReaderThumbCache = nil; // Object
////    
...
//    }
//
//    func thumbRequest(request:ReaderThumbRequest, priority:Bool)
//    {
//    //@synchronized(thumbCache) // Mutex lock
//    //{
//        var object = [thumbCache objectForKey:request.cacheKey];
//        
